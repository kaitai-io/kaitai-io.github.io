  ...
  logical_screen:
    ...
    <div class="col-sm-8">
      ...
      <p>This <code>.ksy</code> file can be compiled
        ...
        / <code>gif.py</code> / <code>gif.rb</code> / <code>gif.rs</code> and
      ...
      <div role="tabpanel" class="tab-pane active" id="download-linux-deb">
        <div class="row">
          <div class="col-sm-9">
            ...
            <pre>curl -fsSLO https://github.com/kaitai-io/kaitai_struct_compiler/releases/download/0.11/kaitai-struct-compiler_0.11_all.deb
sudo apt-get install ./kaitai-struct-compiler_0.11_all.deb</pre>
          </div>
          <div class="col-sm-3">
            <h4>Requirements</h4>
            <ul>
      ...
      <div role="tabpanel" class="tab-pane" id="download-windows">
        <div class="row">
          <div class="col-sm-9">
            ...
            <p><a class="btn btn-success" href="https://github.com/kaitai-io/kaitai_struct_compiler/releases/download/0.11/kaitai-struct-compiler-0.11.msi"><i class="fa fa-download"></i> Download</a> — stable v0.11, 8.5 MiB</p>
          ...
          <div class="col-sm-3">
            ...
            <ul>
              <li>Windows</li>
              <li><a href="https://whichjdk.com/" target="_blank" rel="noopener">Java</a> (LTS version 21 recommended, at least Java 8 required), <a href="https://whichjdk.com/#what-is-the-difference-between-jdk-and-jre" target="_blank" rel="noopener">JDK or JRE</a> at your option</li>
            </ul>
          </div>
        </div>
      </div>
      <div role="tabpanel" class="tab-pane" id="download-universal">
        <div class="row">
          <div class="col-sm-9">
            ...
            <p><a class="btn btn-success" href="https://github.com/kaitai-io/kaitai_struct_compiler/releases/download/0.11/kaitai-struct-compiler-0.11.zip"><i class="fa fa-download"></i> Download</a> — stable v0.11, 8.2 MiB</p>
